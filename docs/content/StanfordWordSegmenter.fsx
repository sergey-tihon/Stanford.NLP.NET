...
#I "../../packages/Stanford.NLP.Segmenter.3.3.0.0/lib"
...
>but would like to support maintenance of these tools, Stanford NLP Group welcome gift funding.
 ...
 <div class="row" style="margin-left: auto; margin-right: auto; display: block;">
  ...
  <div class="span6">
    ...
    <form method="get" action="http://www-nlp.stanford.edu/software/stanford-segmenter-2013-11-12.zip">
...
let segmenterData = __SOURCE_DIRECTORY__ + @"..\..\..\src\temp\stanford-segmenter-2013-11-12\data\"
