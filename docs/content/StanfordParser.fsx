...
#I "../../packages/Stanford.NLP.Parser.3.4.0.0/lib"
...
>If you don't need a commercial license, but would like to support maintenance of these tools, Stanford NLP Group welcomes gift funding.
 ...
 <div class="row" style="margin-left: auto; margin-right: auto; display: block;">
  ...
  <div class="span6">
    ...
    <form method="get" action="http://nlp.stanford.edu/software/stanford-parser-full-2014-06-16.zip">
...
let modelsDirectry = 
    ...
    + @"..\..\..\src\temp\stanford-parser-full-2014-06-16\stanford-parser-3.4-models\"
    + @"edu\stanford\nlp\models\"
...
----------------------------
    ...
    namespace parser
    {
        class Program
        {
            ...
            {
                // Path to models extracted from `stanford-parser-3.4.0-models.jar`
                var jarRoot = @"c:\models\stanford-parser-full-2014-06-16\stanford-parser-3.4-models";
