...
let coreNLPDir = root </> "data/paket-files/nlp.stanford.edu/stanford-corenlp-4.5.0"
...
Target.create "CompilerCoreNLP" (fun _ ->
    ...
    [IKVMcTask(coreNLPDir </> "stanford-corenlp-4.5.0.jar", version=release.AssemblyVersion,
           Dependencies = [
               jodaTime
